...
namespace EasyAbp.DynamicForm.Demo;

public class UnifiedDemoDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    public UnifiedDemoDataSeedContributor(
