...
namespace EasyAbp.DynamicForm.UnifiedDemo.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("DynamicForm") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "DynamicForm",
                DisplayName = "DynamicForm API",
                Resources = { "DynamicForm" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["DynamicForm_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["DynamicForm_Web:RootUrl"]!.EnsureEndsWith('/');

            /* DynamicForm_Web client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["DynamicForm_Web:ClientSecret"] ?? "1q2w3e*",
        ...
        var consoleAndAngularClientId = configurationSection["DynamicForm_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["DynamicForm_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        // Blazor Client
        var blazorClientId = configurationSection["DynamicForm_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["DynamicForm_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        var blazorServerTieredClientId = configurationSection["DynamicForm_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorServerTieredRootUrl = configurationSection["DynamicForm_BlazorServerTiered:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["DynamicForm_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*",
                grantTypes: [OpenIddictConstants.GrantTypes.AuthorizationCode, OpenIddictConstants.GrantTypes.Implicit],
                scopes: commonScopes,
        ...
        var blazorWebAppTieredClientId = configurationSection["DynamicForm_BlazorWebAppTiered:ClientId"];
        if (!blazorWebAppTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorWebAppTieredRootUrl = configurationSection["DynamicForm_BlazorWebAppTiered:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["DynamicForm_BlazorWebAppTiered:ClientSecret"] ?? "1q2w3e*",
                grantTypes: [OpenIddictConstants.GrantTypes.AuthorizationCode, OpenIddictConstants.GrantTypes.Implicit],
                scopes: commonScopes,
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["DynamicForm_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["DynamicForm_Swagger:RootUrl"]?.TrimEnd('/');
